...
function EditNewsForm() {
  ...
  const {
    ...
    refineCoreProps: { resource: "news_posts", action: "edit", id, redirect: "list" },
  });
  ...
  return (
    <div className="flex flex-col gap-6 max-w-3xl">
      <div className="flex items-center gap-3">
        ...
        <h1 className="font-bebas text-4xl tracking-wider text-white">Editar Noticia</h1>
      </div>
      ...
      >
        ...
        <div>
          ...
          <input {...register("published_at")} type="datetime-local" className={FIELD_CLS} />
        </div>

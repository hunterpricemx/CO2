...
export default function FixCategoryEditPage() {
  const back = useBack();
  ...
  const {
    ...
    saveButtonProps,
    refineCore: { onFinish },
  } = useForm<FixCategoryFormValues>({
    refineCoreProps: { resource: "fix_categories", action: "edit", redirect: "list" },
  });
  ...
  return (
    <div className="flex flex-col gap-6 max-w-3xl">
      <div className="flex items-center gap-3">
        ...
        <h1 className="font-bebas text-4xl tracking-wider text-white">Editar categoria</h1>
      </div>

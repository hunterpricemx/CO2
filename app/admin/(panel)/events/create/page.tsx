    ...
    <div className="flex flex-col gap-6 max-w-3xl">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label className={LABEL_CLS}>Título EN *</label>
            <input
          ...
          <div>
            <label className={LABEL_CLS}>Título PT *</label>
            <input
              {...register("title_pt", { required: true })}
              className={FIELD_CLS}
        ...
        <div>
          ...
          {errors.schedule && (
            <p className="mt-1 text-xs text-red-400">Al menos un horario requerido</p>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {(["es", "en", "pt"] as const).map((lang) => (
            <div key={lang}>
              ...
              <textarea
                {...register(`description_${lang}` as any)}
                rows={4}
                className={FIELD_CLS}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {(["es", "en", "pt"] as const).map((lang) => (
            <div key={lang}>
              ...
              <textarea
                {...register(`rewards_${lang}` as any)}
                rows={3}
                className={FIELD_CLS}
                placeholder={`Recompensas en ${lang}`}
              />
            </div>
          ))}
        </div>
